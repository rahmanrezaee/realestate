...
String constructUrlParams(Map<String, String> params) {
  ...
  return p.toString();
   ...
   final List<Map<String, String>> PROVINCES_LIST = [
    {"display": 'ارزگان', "value": 'Uruzgan'},
    {"display": 'بادغیس', "value": 'Badghis'},
    {"display": 'بامیان', "value": 'Bamyan'},
    {"display": 'بدخشان', "value": 'Badakhshan'},
    {"display": 'بغلان', "value": 'Baghlan'},
    {"display": 'بلخ', "value": 'Balkh'},
    {"display": 'پروان', "value": 'Parwan'},
    {"display": 'پکتیا', "value": 'Paktia'},
    {"display": 'پکتیکا', "value": 'Paktika'},
    {"display": 'پنجشیر', "value": 'Panjshir'},
    {"display": 'تخار', "value": 'Takhar'},
    {"display": 'جوزجان', "value": 'Jowzjan'},
    {"display": 'خوست', "value": 'Khost'},
    {"display": 'دایکندی', "value": 'Daykundi'},
    {"display": 'زابل', "value": 'Zabul'},
    {"display": 'سرپل', "value": 'SarePol'},
    {"display": 'غزنی', "value": 'Ghazni'},
    {"display": 'غور', "value": 'Ghor'},
    {"display": 'فاریاب', "value": 'Faryab'},
    {"display": 'فراه', "value": 'Farah'},
    {"display": 'قندهار', "value": 'kandahar'},
    {"display": 'قندوز', "value": 'Kunduz'},
    {"display": 'کابل', "value": 'kabul'},
    {"display": 'کاپیسا', "value": 'Kapisa'},
    {"display": 'کنر', "value": 'konar'},
    {"display": 'لغمان', "value": 'lagman'},
    {"display": 'لوگر', "value": 'logar'},
    {"display": 'مزار شریف', "value": 'mazaresharif'},
    {"display": 'میدان وردک', "value": 'maydanwardak'},
    {"display": 'نورستان', "value": 'nooristan'},
    {"display": 'نیمروز', "value": 'nemroz'},
    {"display": 'هرات', "value": 'herat'},
    {"display": 'هلمند', "value": 'helmand'},
  ];
